---
title: ".b[Frequentist Inference, pt. I]"
...
```{r, echo=FALSE, dev = "svg", fig.height=3.5, fig.width=6}
min <- -3.5
max <- 3.5
...
```{r, echo=FALSE, dev = "svg", fig.height=5, fig.width=7}
min2 <- 500
max2 <- 1500
...
ggplot(data.frame(x = c(min, max)), aes(x = x)) +
  ...
  geom_area(stat = "function", fun = dnorm, args = list(mean = 0, sd = 1), 
            fill = "#b70673", xlim = c(-3.5, 1), alpha = 0.4) +
  easy_x_axis_title_size(13) +
  easy_y_axis_title_size(13)
...
```{r, echo=FALSE, dev = "svg", fig.height=3, fig.width=5}
...
ggplot(data.frame(x = c(min, max)), aes(x = x)) +
  ...
  labs(x = "x",
       y = "") +
  geom_area(stat = "function", fun = dnorm, args = list(mean = 0, sd = 1), 
            fill = "#b70673", xlim = c(-1.64, 1.64), alpha = 0.4) +
